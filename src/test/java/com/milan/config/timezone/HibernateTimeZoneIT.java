package com.milan.config.timezone;

import com.milan.GithubtestApp;
import com.milan.config.SecurityBeanOverrideConfiguration;
import com.milan.repository.timezone.DateTimeWrapper;
import com.milan.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, GithubtestApp.class})
